...
class VolumeImbalanceBarProcessor : public ImbalanceBarProcessor
{
private:
    /**
...
public:
     ...
     */
    VolumeImbalanceBarProcessor(float E_T=100, float alpha_b=0.95) : 
