...
class DollarRunsBarProcessor : public RunsBarProcessor
{
private:
    /**
...
public:
     ...
     *  @param  sells
     */
    DollarRunsBarProcessor(EMAValue T=100, EMAValue buys=100000, EMAValue sells=100000) : 
